...
archivo=["histomagnet.txt"] #"Temperatura -Magnetizacion prom <m>"
...
plt.plot(magnet[0][0],magnet[0][1],'r')
...
#Grafico Histograma:
plt.figure(2)
plt.bar(hcentro,hcuenta,float(hbin),color='red')
plt.xlabel(r'$Magnetizacion$'+' '+r'$<M>$', fontsize=20)
plt.ylabel(r'$Frecuencia$'+' '+r'$normalizada$', fontsize=20)
plt.show()
